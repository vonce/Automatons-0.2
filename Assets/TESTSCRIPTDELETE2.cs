...
public class TESTSCRIPTDELETE2 : MonoBehaviour
{
    ...
    void Awake()
    {
        logicGate0.objectCondition = gameObject.AddComponent<NearestAlly>();
        logicGate0.condition = gameObject.AddComponent<LessThanHealth>();
        logicGate0.conditionSubOption.subOption = true;
        logicGate0.conditionSubOption.percent = 80;
        logicGate0.action = gameObject.AddComponent<Special>();
        logicGate0.objectAction = gameObject.AddComponent<NearestAlly>();

        logicGate1.objectCondition = gameObject.AddComponent<Self>();
        logicGate1.condition = gameObject.AddComponent<LessThanHealth>();
        logicGate1.conditionSubOption.subOption = true;
        logicGate1.conditionSubOption.percent = 40;
        logicGate1.action = gameObject.AddComponent<Move>();
        logicGate1.objectAction = gameObject.AddComponent<AllyCommand>();
        ...
        logicGate2.objectAction = gameObject.AddComponent<NearestEnemy>();
